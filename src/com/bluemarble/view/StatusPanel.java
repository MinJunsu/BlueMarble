...
public class StatusPanel extends JPanel
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g.drawString(country.getVillaPrice() * country.getVillaCount() + " 원",150, 86);
        ...
        g.drawString(country.getBuildingPayPrice() + "원",250, 124);
        ...
        g.drawString(country.getBuildingPayPrice() + "원",250, 162);
